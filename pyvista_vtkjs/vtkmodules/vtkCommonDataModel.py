VTK_BEZIER_CURVE = 1
VTK_BEZIER_HEXAHEDRON = 1
VTK_BEZIER_PYRAMID = 1
VTK_BEZIER_QUADRILATERAL = 1
VTK_BEZIER_TETRAHEDRON = 1
VTK_BEZIER_TRIANGLE = 1
VTK_BEZIER_WEDGE = 1
VTK_BIQUADRATIC_QUAD = 1
VTK_BIQUADRATIC_QUADRATIC_HEXAHEDRON = 1
VTK_BIQUADRATIC_QUADRATIC_WEDGE = 1
VTK_BIQUADRATIC_TRIANGLE = 1
VTK_CONVEX_POINT_SET = 1
VTK_CUBIC_LINE = 1
VTK_EMPTY_CELL = 1
VTK_HEXAGONAL_PRISM = 1
VTK_HEXAHEDRON = 1
VTK_HIGHER_ORDER_EDGE = 1
VTK_HIGHER_ORDER_HEXAHEDRON = 1
VTK_HIGHER_ORDER_POLYGON = 1
VTK_HIGHER_ORDER_PYRAMID = 1
VTK_HIGHER_ORDER_QUAD = 1
VTK_HIGHER_ORDER_TETRAHEDRON = 1
VTK_HIGHER_ORDER_TRIANGLE = 1
VTK_HIGHER_ORDER_WEDGE = 1
...
VTK_LINE = 1
VTK_PARAMETRIC_CURVE = 1
VTK_PARAMETRIC_HEX_REGION = 1
VTK_PARAMETRIC_QUAD_SURFACE = 1
VTK_PARAMETRIC_SURFACE = 1
VTK_PARAMETRIC_TETRA_REGION = 1
VTK_PARAMETRIC_TRI_SURFACE = 1
VTK_PENTAGONAL_PRISM = 1
VTK_PIXEL = 1
VTK_POLYGON = 1
VTK_POLYHEDRON = 1
VTK_POLY_LINE = 1
...
VTK_PYRAMID = 1
VTK_QUAD = 1
VTK_QUADRATIC_EDGE = 1
VTK_QUADRATIC_HEXAHEDRON = 1
VTK_QUADRATIC_LINEAR_QUAD = 1
VTK_QUADRATIC_LINEAR_WEDGE = 1
VTK_QUADRATIC_POLYGON = 1
VTK_QUADRATIC_PYRAMID = 1
VTK_QUADRATIC_QUAD = 1
VTK_QUADRATIC_TETRA = 1
VTK_QUADRATIC_TRIANGLE = 1
VTK_QUADRATIC_WEDGE = 1
VTK_TETRA = 1
VTK_TRIANGLE = 1
VTK_TRIANGLE_STRIP = 1
VTK_TRIQUADRATIC_HEXAHEDRON = 1
VTK_TRIQUADRATIC_PYRAMID = 1
VTK_VERTEX = 1
VTK_VOXEL = 1
VTK_WEDGE = 1
